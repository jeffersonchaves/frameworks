...
<body>
    ...
    <header>
        ...
        <nav class="navbar navbar-expand-md text-dark bg-pink">
        ...
        <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img src="https://dummyimage.com/1200x250/2011f0/ffffff.png&text=pokebanner1" class="img-fluid w-100" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img src="https://dummyimage.com/1200x250/2011f0/ffffff.png&text=pokebanner2" class="img-fluid w-100" alt="Second slide">
                </div>
